...
local song_meta = {
    __index = {
        ...
        drawUi = function(self, level, time, score, highscore, cleared)
            ...
            utils.printfWithShadow( level, _FONTMAN.getFont(24), 752, 136, 182, "right" )              -- level
            utils.printfWithShadow( utils.getTimeString( time ), _FONTMAN.getFont(24), 752, 216, 182, "right" )   -- time
            utils.printfWithShadow( score, _FONTMAN.getFont(24), 752, 296-6, 182, "right" )            -- score
            utils.printfWithShadow( highscore, _FONTMAN.getFont(24), 752, 376-10, 182, "right" )       -- highscore
            utils.printfWithShadow( cleared, _FONTMAN.getFont(24), 752, 456-10, 182, "right" )         -- clear count
        end,
